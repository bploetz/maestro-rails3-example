...
attribute "mysql/tunable/query_cache_limit",
  :display_name => "MySQL Tunable Query Cache Limit",
  :default => "1M"

attribute "mysql/tunable/query_cache_size",
  :display_name => "MySQL Tunable Query Cache Size",
  :default => "16M"
